// Import schema to PocketBase using the SDK
...
// Schema file path (you can change this to use any of the schema files)
...
async function importSchema() {
  try {
    ...
    // Read schema file
    console.log(`Reading schema from ${SCHEMA_FILENAME}...`);
